...
func TestAccEdaProjectResource(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccEdaProjectResourceConfig(edaproject1),
				ConfigStateChecks: []statecheck.StateCheck{
					statecheck.ExpectKnownValue(
						fmt.Sprintf("%s_eda_project.test", configprefix.Prefix),
						tfjsonpath.New("name"),
			...
			{
				Config: testAccEdaProjectResourceConfig(edaproject2),
				ConfigStateChecks: []statecheck.StateCheck{
					statecheck.ExpectKnownValue(
						fmt.Sprintf("%s_eda_project.test", configprefix.Prefix),
						tfjsonpath.New("name"),
...
func testAccEdaProjectResourceConfig(resource EdaProjectAPIModel) string {
	return fmt.Sprintf(`
