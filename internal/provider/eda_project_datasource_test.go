		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet(fmt.Sprintf("data.%s_eda_project.test", configprefix.Prefix), "scm_type"),
					resource.TestCheckResourceAttrSet(fmt.Sprintf("data.%s_eda_project.test", configprefix.Prefix), "organization_id"),
					resource.TestCheckResourceAttrSet(fmt.Sprintf("data.%s_eda_project.test", configprefix.Prefix), "organization_name"),
				),
			},
		},
	})
