...
- `kind` (String) Leave empty for regular inventories. Set to `constructed` for constructed. Set to `smart` for smart inventories (AAP documentation recommends against using smart type - use constructed.)
